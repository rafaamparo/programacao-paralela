...
int main(int argc, char *argv[]) {
    ...
    double t0, t1;
    MPI_Status estado;
    MPI_Request request; // Variável para controlar requisições não-bloqueantes
    ...
    // Preparar buffer para MPI_Bsend
    void* buffer = malloc(TAMANHO_BUFFER);
    ...
    // Desanexar o buffer antes de finalizar
    void* buffer_addr;
    int buffer_size;
